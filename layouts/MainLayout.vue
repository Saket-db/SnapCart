        ...
        >
            ...
            <div v-if="true">
                ...
                <div class = "flex items-center gap-1 px-3 mb-3">
                    <NuxtLink 
                    to = "/auth"
                    class="bg-[#FF4646] text-center w-full text-[16px] rounder-sm font-light px-1 py-2 text-white">
                    Login / Register
                    </NuxtLink>
                </div>
            </div>
